...
export function CountryLanguageSelector() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-dark-600 to-dark-400 p-4">
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="w-full max-w-md bg-dark-600 rounded-2xl shadow-xl overflow-hidden"
      >
        {/* Header */}
          ...
          <div>
            ...
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between p-3 border border-dark-300 rounded-lg bg-dark-600 hover:bg-dark-500 transition-colors"
              >
              ...
              <AnimatePresence>
                {isOpen && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="absolute z-10 mt-1 w-full bg-dark-600 border border-dark-400 rounded-lg shadow-lg overflow-hidden"
                  >
                    <div className="max-h-60 overflow-y-auto">
                      {COUNTRIES.map((country) => (
                        <button
                          ...
                          className={cn(
                            "w-full text-left px-4 py-3 flex items-center hover:bg-dark-500 transition-colors",
                            selectedCountry.code === country.code ? "bg-indigo-50 text-indigo-700" : "text-gray-200"
                          )}
                        >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedLanguage.code === language.code
                      ...
                      : "border-dark-300 hover:border-dark-200 bg-dark-600 text-gray-300"
                  )}
        ...
        <div className="px-6 py-4 bg-dark-500 border-t border-dark-400 text-center">
