      ...
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-400">Update the product details below</p>
          </motion.div>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="mt-2">
                        <div className="flex items-center justify-center w-full">
                          <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dark-300 border-dashed rounded-lg cursor-pointer bg-dark-500 hover:bg-dark-400">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {formData.sizes.map((size, index) => (
                          <div key={index} className="border border-dark-400 rounded-lg p-4 bg-dark-500">
                            <div className="grid md:grid-cols-4 gap-3 items-end">
                              ...
                              <div>
                                ...
                                <Input
                                  ...
                                  placeholder="200.00"
                                />
                                <p className="text-xs text-gray-400 mt-1">Price in USD</p>
                              </div>
                              <div>
                    ...
                    <div className="flex items-center justify-end space-x-4 pt-6">
                      ...
                      <Button type="submit" className="bg-black text-white hover:bg-dark-700" disabled={loading}>
                        {loading ? (
                          <>
