...
export default function FavoritesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-dark-600 to-dark-500">
      <Navigation />
      ...
      {showSizeSelector && selectedProduct && (
        ...
        >
          <motion.div 
            className="bg-dark-600 rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto overflow-x-hidden shadow-2xl relative"
          ...
          >
            ...
            <div className="p-6 relative z-10">
              ...
              <div className="mb-6">
                ...
                />
                {isCustomSizeMode && (
                  <div className="mt-4 text-sm text-gray-400 bg-dark-500 p-3 rounded-lg flex items-center">
      ...
      <section className="pt-28 md:pt-24 pb-16">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            ...
            className="mb-8"
          >
            <Link href="/" className={`inline-flex items-center text-gray-400 hover:text-white mb-6 transition-colors ${settings.language === "ar" ? "flex-row-reverse" : ""}`}>
                ...
                <div className={`flex items-center ${settings.language === "ar" ? "space-x-reverse space-x-4" : "space-x-4"}`}>
                  {!showClearConfirm ? (
                    ...
                    <div className={`flex items-center ${settings.language === "ar" ? "space-x-reverse space-x-2" : "space-x-2"}`}>
                      <span className="text-sm text-gray-400">{t("areYouSure")}</span>
                ...
                >
                  <div className="group relative h-full">
                    ...
                    <motion.button
                      ...
                      className="absolute top-4 right-6 z-10 p-2.5 bg-dark-600/95 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl hover:bg-dark-600 transition-all duration-300"
                      aria-label="Remove from favorites"
                    >
                        ...
                        <Link href={`/products/${item.category}/${item.id}`} className="block relative aspect-square flex-grow">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <button 
                                className="p-2 bg-dark-600/20 backdrop-blur-sm rounded-full hover:bg-dark-600/30 transition-colors flex-shrink-0"
                                onClick={(e) => {
                                  e.preventDefault()
                                  e.stopPropagation()
