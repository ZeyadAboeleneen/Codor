  ...
  return (
    <div className="min-h-screen bg-dark-400 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Auth State */}
        <div className="bg-dark-600 p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Auth State</h2>
          <pre className="bg-dark-400 p-4 rounded text-sm overflow-auto">
          ...
          {favoritesState.items.length > 0 && (
            <div className="space-y-4">
              ...
              {favoritesState.items.map((item, index) => (
                <div key={index} className="border p-4 rounded bg-dark-500">
      ...
      {/* Raw Favorites Data */}
      <div className="mt-8 bg-dark-600 p-6 rounded-lg shadow">
