...
export default function ProductDetailPage() {
        ...
        <div className="pt-28 md:pt-24 px-4">
          {loading ? (
            <div className="container mx-auto px-4 md:px-6">
              {/* Skeleton Loader */}
              <div className="mb-8 h-6 bg-dark-300 rounded w-32 animate-pulse"></div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
                {/* Image Skeleton */}
                <div className="space-y-4">
                  <div className="aspect-square bg-dark-300 rounded-xl animate-pulse"></div>
                  <div className="flex space-x-3">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="w-20 h-20 bg-dark-300 rounded-lg animate-pulse"></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    <div className="h-8 bg-dark-300 rounded w-3/4 animate-pulse"></div>
                    <div className="h-5 bg-dark-300 rounded w-1/2 animate-pulse"></div>
                    <div className="h-7 bg-dark-300 rounded w-24 animate-pulse"></div>
                  </div>
                  <div className="space-y-2">
                    <div className="h-4 bg-dark-300 rounded w-full animate-pulse"></div>
                    <div className="h-4 bg-dark-300 rounded w-full animate-pulse"></div>
                    <div className="h-4 bg-dark-300 rounded w-2/3 animate-pulse"></div>
                  </div>
                  <div className="h-px bg-dark-300"></div>
                  <div className="space-y-3">
                    <div className="h-6 bg-dark-300 rounded w-32 animate-pulse"></div>
                    <div className="grid grid-cols-4 gap-2">
                      {[...Array(4)].map((_, i) => (
                        <div key={i} className="h-12 bg-dark-300 rounded animate-pulse"></div>
                      ))}
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center">
              ...
              <Link href="/products">
                <Button className="bg-black text-white hover:bg-dark-700 text-sm sm:text-base px-4 py-2">Browse All Products</Button>
              </Link>
            </div>
          )}
        </div>
  ...
  return (
    <div className="min-h-screen bg-dark-600">
      ...
      <section className="pt-28 md:pt-24 pb-20 sm:pb-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <Link
              href="/products"
              className="inline-flex items-center text-gray-400 hover:text-white transition-colors font-medium text-sm sm:text-base"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
            {loading && !product && (
              <div className="col-span-full flex items-center justify-center py-16">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base">Loading product details...</p>
                </div>
              </div>
            )}
            ...
            >
              <div className="relative rounded-xl overflow-hidden bg-dark-500">
                <div
                  ...
                  {product.images?.length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 p-2 sm:p-3 rounded-full bg-dark-600/90 backdrop-blur shadow hover:bg-dark-600 focus:outline-none focus:ring-2 focus:ring-gold-500"
                      ...
                      <button
                        ...
                        className="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 p-2 sm:p-3 rounded-full bg-dark-600/90 backdrop-blur shadow hover:bg-dark-600 focus:outline-none focus:ring-2 focus:ring-gold-500"
            ...
            >
              <div>
                          ...
                          return (
                            <div className="text-left space-y-2">
                              <div className="flex flex-col items-start">
                                <span className="text-gray-400 text-base sm:text-lg">Package Price:</span>
                ...
                <div className="mb-6">
                  <p className={`text-gray-300 text-sm sm:text-base leading-relaxed ${showFullDescription ? '' : 'line-clamp-3'}`}>
                    {product.longDescription}
                  </p>
                  {!showFullDescription && (
                    <button
                      onClick={() => setShowFullDescription(true)}
                      className="text-sm font-medium text-white mt-3 flex items-center hover:text-gray-300 transition-colors w-full sm:w-auto justify-center sm:justify-start"
                    >
                  ...
                  {product.isGiftPackage && product.giftPackageSizes && (
                    <div className="mt-4 p-3 sm:p-4 bg-dark-500 rounded-lg">
                      <div className="flex items-center space-x-2 mb-3">
                        <Package className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" />
                        <h4 className="font-medium text-white text-sm sm:text-base">Gift Package Includes:</h4>
                      </div>
                      <div className="grid grid-cols-1 gap-2">
                        {product.giftPackageSizes.map((size, index) => (
                          <div key={index} className="text-xs sm:text-sm text-gray-400">
                  ...
                  <div className="flex items-center space-x-4 pt-2">
                    ...
                    <div className="flex items-center space-x-2 bg-dark-500 rounded-lg p-1 border border-white/5">
                      <motion.button
                        ...
                        className="w-8 h-8 rounded flex items-center justify-center hover:bg-dark-400 transition-colors text-white"
                        disabled={quantity <= 1}
                      >
                        -
                      </motion.button>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-dark-600 shadow-lg border-t border-dark-400 z-40">
          ...
          {product.isGiftPackage ? (
            ...
            <div className="flex items-center justify-between gap-2 md:gap-4">
              <div className="flex items-center space-x-2 md:space-x-3 min-w-0 flex-1">
                <Package className="h-4 w-4 md:h-6 md:w-6 text-gray-400 flex-shrink-0" />
                <div className="min-w-0 flex-1">
                  <h3 className="text-xs md:text-sm font-medium text-white truncate">Gift Package</h3>
                  <p className="text-xs text-gray-400 hidden md:block">Customize your package</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2 md:space-x-4">
                ...
                <div className="flex space-x-1 md:space-x-2">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="p-2 md:p-3 border border-dark-400 rounded-lg hover:bg-dark-500 flex items-center justify-center"
                    onClick={() => {
                      if (product) {
            ...
            <div className="space-y-2 md:space-y-0">
              {/* Mobile: Compact single row layout removed from sticky bar, quantity is now in main content */}
              ...
              <div className="flex md:hidden items-center justify-between gap-2">
                ...
                <div className="flex space-x-1">
                  <motion.button
                    whileHover={{ scale: 1.03 }}
                    whileTap={{ scale: 0.98 }}
                    className="p-2 border border-dark-400 rounded-lg hover:bg-dark-500 flex items-center justify-center"
                    onClick={() => {
                      if (product) {
                        if (isFavorite(product.id)) {
                          removeFromFavorites(product.id)
                  ...
                  <motion.button
                    ...
                    className={`bg-gradient-to-r text-white py-2 px-4 rounded-lg font-medium flex items-center justify-center shadow-md transition-all text-xs ${product.isOutOfStock || (!isCustomSizeMode && selectedSize >= 0 && product.sizes[selectedSize]?.stockCount !== undefined && product.sizes[selectedSize].stockCount === 0) || (isCustomSizeMode && !isMeasurementsValid)
                      ? 'from-gray-400 to-dark-5000 cursor-not-allowed opacity-60'
              ...
              <div className="hidden md:flex md:items-center md:justify-between gap-4">
                ...
                <div className="w-auto">
                  <h3 className="text-sm font-medium mb-2 text-white">Size: {product.sizes[selectedSize]?.size}</h3>
                      ...
                      <motion.button
                        ...
                        className={`px-4 py-2 border rounded-lg text-center transition-all flex-shrink-0 text-base ${size.stockCount !== undefined && size.stockCount === 0
                          ...
                          : selectedSize === index
                            ...
                            : 'border-dark-400 hover:border-dark-200 bg-dark-600'
                          }`}
                      >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => setQuantity(Math.max(1, quantity - 1))}
                      className="w-8 h-8 border border-dark-400 rounded-lg flex items-center justify-center hover:bg-dark-500 transition-colors"
                      disabled={quantity <= 1}
                    >
                ...
                <div className="flex items-center justify-end space-x-4 w-auto">
                  ...
                  <div className="flex justify-end space-x-2">
                    <motion.button
                      whileHover={{ scale: 1.03 }}
                      whileTap={{ scale: 0.98 }}
                      className="p-3 border border-dark-400 rounded-lg hover:bg-dark-500 flex items-center justify-center"
                      onClick={() => {
                        if (product) {
                          if (isFavorite(product.id)) {
                            removeFromFavorites(product.id)
      ...
      {/* Reviews Section */}
      <section className="py-12 sm:py-16 bg-gradient-to-b from-dark-600 to-dark-500">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 sm:space-y-8">
              {reviews.length === 0 ? (
                <div className="text-center py-8 sm:py-12 bg-dark-600 rounded-xl shadow-sm border border-dark-400">
                  <div className="bg-dark-400 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                reviews.map((review, index) => (
                  <motion.div
                    ...
                    className="bg-dark-600 p-4 sm:p-6 rounded-xl shadow-sm border border-dark-400"
                  >
                    <div className="flex items-start mb-4">
                      <div className="bg-dark-300 border-2 border-dashed rounded-xl w-12 h-12 sm:w-16 sm:h-16 flex-shrink-0" />
                      <div className="ml-3 sm:ml-4 flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                          <div>
                            <h4 className="font-medium text-white text-sm sm:text-base">{review.userName}</h4>
      ...
      <section className="py-12 sm:py-16 bg-dark-500 pb-24 sm:pb-28">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-8 sm:mb-12">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <div className="group relative h-full">
                    ...
                    <motion.button
                      ...
                      className="absolute top-2 right-2 sm:top-4 sm:right-6 z-10 p-2 sm:p-2.5 bg-dark-600/95 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl hover:bg-dark-600 transition-all duration-300"
                          ...
                          <Link href={`/products/${relatedProduct.category}/${relatedProduct.id}`} className="block relative w-full h-full">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3 md:p-4 text-white">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  className={`p-1 sm:p-1.5 sm:p-2 bg-dark-600/20 backdrop-blur-sm rounded-full hover:bg-dark-600/30 transition-colors ${relatedProduct.isOutOfStock
      ...
      {showSizeSelector && selectedProduct && (
        ...
        >
          <motion.div
            className="bg-dark-600 rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl"
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex">
                  <button
                    ...
                    className="mr-2 p-1.5 bg-dark-600/80 backdrop-blur-sm rounded-full shadow-md hover:bg-dark-400 transition-colors"
                  >
                    <Heart
              ...
              <div className="flex justify-between items-center py-4 border-t border-dark-400">
                ...
                <Button
                  ...
                  className={`flex items-center bg-black hover:bg-dark-700 rounded-full px-6 py-5 ${selectedProduct?.isOutOfStock
                    ? 'cursor-not-allowed opacity-60'
                    : ''
                    }`}
                  disabled={
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2 pt-2">
              ...
              <div className="bg-dark-500 p-4 rounded-lg space-y-1 text-sm">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className="bg-black hover:bg-dark-700"
            >
              Confirm & Buy Now
            </AlertDialogAction>
          </AlertDialogFooter>
