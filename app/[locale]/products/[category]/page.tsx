...
export default function CategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-600">
      ...
      {/* Hero Section */}
      <section className="pt-28 md:pt-24 pb-4 bg-gradient-to-b from-dark-600 to-dark-500">
        ...
        <div className="container mx-auto px-6">
          <div className="mb-10 max-w-2xl mx-auto">
            ...
            <div className="relative group">
              ...
              <Input
                ...
                className={`w-full rounded-full border border-dark-400 bg-dark-600/90
          ...
          {(debouncedQuery && filteredProducts.length === 0 && products.length > 0) ? (
            ...
            <div className="text-center py-16">
              ...
              <Link href="/products">
                <Button className="mt-4 bg-black text-white hover:bg-dark-700">Browse All Collections</Button>
              </Link>
            </div>
          ) : (
            <>
                            ...
                            <Link href={`/products/${category}/${product.id}`} className="block relative aspect-square flex-grow">
                              ...
                              <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                                ...
                                <div className="flex items-end justify-between gap-2">
                                  ...
                                  <button 
                                    className="p-2 bg-dark-600/20 backdrop-blur-sm rounded-full hover:bg-dark-600/30 transition-colors"
                                    onClick={(e) => {
                                      e.preventDefault()
                                      e.stopPropagation()
                                      if (product.isGiftPackage) {
