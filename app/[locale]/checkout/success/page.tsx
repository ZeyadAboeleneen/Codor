        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4 text-left">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1">Custom designs may require additional time</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            >
              ...
              <div className="text-sm text-gray-400 space-y-4 pt-4 border-t border-dark-400">
                <p>
                  Need help? Contact us at{" "}
                  <a href="mailto:alanodalqadi@gmail.com" className="text-white hover:underline">
